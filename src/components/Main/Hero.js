            ...
            <Container>
                <div className='inner-hero'>
                    <div className='hero-left'>
                        ...
                        <HeroPara>Software Engineer II | Java | Spring Boot | Node.js | React.js and Docker Enthusiast</HeroPara>
                        <div className='hero-links'>
                            <div>
                                ...
                                <a href='https://www.linkedin.com/in/vyshak-g-gowda/' target='_blank' rel='noopener noreferrer' alt='linkedin'>
                            ...
                            <div className='resume-preview-right-icon'>
                                ...
                                <a href='https://drive.google.com/file/d/1DvskwJ4SDa7QaXIG5ouS4A1D4px2w1BE/view?usp=sharing' target='_blank' rel='noopener noreferrer' alt='github'>
                                    <HeroIconsLink
                        ...
                        <div style={{ display: 'flex', marginTop: '1rem' }}>
                            <input type='checkbox' id='switch' defaultChecked={!themeState.dark} onClick={() => themeState.toggle()} />
                    ...
                    <div className='hero-media'>
                        <div className='header-illustration'>
                            <img className='header-illustration-image asset-dark' src={themeState.images.headerIllustration} alt='Header illustration' />
                        </div>
                        <div className='hero-media-illustration'>
                            <img className='hero-media-illustration-image asset-dark' src={themeState.images.heroMediaIllustration} alt='Hero media illustration' />
                        </div>
